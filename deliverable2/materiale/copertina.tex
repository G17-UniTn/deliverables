...
\textit{Descrizione:} documento di specifica dei requisiti funzionali e non funzionali mediane \textit{use case diagrams}, tabelle e diagrammi di contesto e dei componenti.
\end{minipage}\\[1.5cm]

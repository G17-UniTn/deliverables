...
\begin{description}
    ...
    \begin{enumerate}
        ...
        \item La registrazione con sistema di credenziali interno prevede l'inserimento di un username, un'email valida e una password conforme. \verb|[exception 1]|\verb|[exception 2]|

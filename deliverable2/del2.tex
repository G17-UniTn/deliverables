...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item \underline{Richiesta recupero account:}
        \item \underline{Email di recupero:}
        \item \underline{Nuova password:}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \underline{Invio messaggio di recupero:}
        \item \underline{Esito:}
        \item \underline{Aggiornamento password:}
    \end{itemize}
\end{description}
...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item \underline{Modifiche preferiti:}
        \item \underline{Nuove credenziali:}
        \item \underline{Richiesta logout:}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \underline{Preferiti:}
        \item \underline{Modifiche preferiti:}
        \item \underline{Progressi:}
        \item \underline{Aggiorna progressi:}
        \item \underline{Problemi risolti:}
        \item \underline{Nuove credenziali:}
        \item \underline{Aggiorna credenziali:}
    \end{itemize}
\end{description}
...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item \underline{Problemi:}
        \item \underline{Richiesta hint:}
        \item \underline{Filtri:}
        \item \underline{Video:}
        \item \underline{Selezione problema:}
        \item \underline{Autorizzazione:}
        \item \underline{Modifiche preferiti:}
        \item \underline{Modifiche catalogo:}
        \item \underline{Preferiti:}
        \item \underline{Problemi risolti:}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \underline{Lista:}
        \item \underline{Hint:}
        \item \underline{Richiesta video:}
        \item \underline{Problema:}
        \item \underline{Stati:}
        \item \underline{Preferiti:}
        \item \underline{Modifiche preferiti:}
    \end{itemize}
\end{description}
...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item \underline{Problema:}
        \item \underline{Selezione linguaggio:}
        \item \underline{Codice:}
        \item \underline{Richiesta submit:}
        \item \underline{Start/stop/reset cronometro:}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \underline{Contenuto problema:}
        \item \underline{Linguaggi:}
        \item \underline{Test cases:} (sia esito che input-output previsti dal test)
        \item \underline{Tempo:}
        \item \underline{Problema risolto:}
    \end{itemize}
\end{description}

...
ricorre qui ad una descrizione testuale seguita da una rappresentazione
grafica mediante Context Diagram (Figura \ref{contextdiagram}).
...
\textbf{RF 13}, \textbf{RF 14} per quanto riguarda il livello amministratore.

\subsubsection{Firebase DB}
Il servizio di database impiegato per gestire le credenziali e l'account
degli utenti registrati alla piattaforma—come specificato in \textbf{RF 1},
\textbf{RF 2}, \textbf{RF 3}, \textbf{9}, \textbf{10}—e per gestire il
...
Il servizio di contenuti multimediali che fornisce i video con i quali
integrare i problemi—\textbf{RF 4.1}, \textbf{RF 7.6}.
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{materiale/contextdiagram.pdf}

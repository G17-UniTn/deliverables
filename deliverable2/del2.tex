...
i dettagli dello Use Case \textit{Eliminazione account}. Viene in particolare
specificato che i problemi preferiti, salvati nell'account, vengono aggiornati
nel loro valore di preferito (ovvero il numero di utenti registrati che
hanno contrassegnato come preferito quel particolare problema).

...
\begin{figure}[H]
\centering
\includegraphics[scale=0.65]{materiale/swimlaneemail.pdf}
\caption{Swimlane Diagram dello scenario di aggiornamento dell'indirizzo email}
\label{slemail}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.65]{materiale/swimlanepassword.pdf}

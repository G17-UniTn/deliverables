...
Progressi. In aggiunta agli strumenti disponibili per effettuare l'esercitazione,
...
\caption{UCD con riferimenti ai requisiti relativi ai tools di esercitazione e al cronometro}
\label{esercitaz}
\end{figure}
...
L'utente può inoltre vedere il tempo registrato dal cronometro e manipolarlo (\textbf{RF 9})

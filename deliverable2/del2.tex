...
\centering
%\hspace*{-0.4cm}
\includegraphics[scale=0.6]{materiale/ucdiagrams/swimlaneesercitazione.pdf}
...
Qualora lo ritenga opportuno, l'utente può interrompere questa procedura di migrazione,
fino alla condizione \textit{conferma operazione}.
In più, viene specificato il comportamento che
il sistema adotta nel caso in cui venga inserita un'email già associata ad un
altro account registrato sulla piattaforma.

\begin{figure}[H]
\centering
\hspace*{-1cm}
\includegraphics[scale = 0.89]{materiale/ucdiagrams/swimlaneemail.pdf}

...
\begin{itemize}
    \item \textbf{RF 6.} Effettuare l'esercitazione
...
(si fa anche riferimento agli use case \textit{Avviare e interrompere un
...
in qualsiasi momento, si sottolinea che il processo descritto nel diagramma
può essere interrotto in qualsiasi momento (ciò è indicato dalla codizione
\textit{Esci}). Inoltre, una volta attivato
il cronometro, esso può essere fermato e riavviato in qualsiasi momento

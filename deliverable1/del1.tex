...
\begin{itemize}
    ...
    che siano rispettati i vincoli del \underbar{\hyperref[legalpassword]{RNF \ref*{legalpassword}}};
...
\begin{itemize}
    ...
    conforme al \underbar{\hyperref[legalpassword]{RNF \ref*{legalpassword}}}.
\end{itemize}
\end{funcreq}
...
\begin{enumerate}
    ...
    elencato (descritti nel \underbar{\hyperref[metadata]{RNF \ref*{metadata}}}).
    ...
    delle funzionalità di cui al \underbar{\hyperref[seeproblem]{RF \ref*{seeproblem}}}.
\end{enumerate}
\end{funcreq}
...
\begin{enumerate}
    \item Visualizzare il contenuto dell'esercizio (\underbar{\hyperref[formatoproblema]{RNF \ref*{formatoproblema}}}).
    
    \item Visualizzare i test cases (\underbar{\hyperref[test]{RNF \ref*{test}.2}}).
...
\begin{enumerate}
    ...
    \textit{risolto} nel campo \textit{stato} del problema e i progressi (\underbar{\hyperref[stats]{RF \ref*{stats}}}) devono
    essere aggiornati.
\end{enumerate}
\end{funcreq}
...
per conferma e deve rispettare quanto specificato dal \underbar{\hyperref[legalpassword]{RNF \ref*{legalpassword}}}. 

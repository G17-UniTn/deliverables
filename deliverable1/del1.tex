...
\end{enumerate}
L'esercitazione non è da confondersi come "sessione" della quale la piattaforma
registra lo stato. In altre parole, l'utente può accedere all'area di
esercitazione (selezionando un problema) e abbandonarla in qualsiasi momento, ma
nessun dato cronologico o di altra natura, riguardo a tali azioni, deve essere
memorizzato, nemmeno nel caso in cui l'utente in questione sia autenticato.
\end{funcreq}

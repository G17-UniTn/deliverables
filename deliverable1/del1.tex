...
insieme ai dati ad esso collegati (preferiti, progressi ecc.). L'eliminazione
è consentita sia a utenti registrati mediante il sistema di credenziali
interno sia a coloro che hanno effettuato la registrazione per mezzo di un
account Google. L'operazione di eliminazione prevede la digitazione della
parola chiave \texttt{conferma}.
\end{funcreq}
...
%i progressi degli utenti che hanno risolto quel problema cosa fanno?
\end{funcreq}
...
(\textcolor{blue}{\underbar{\hyperref[probcatalogue]{RF \ref*{probcatalogue}}}})

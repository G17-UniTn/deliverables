...
\begin{enumerate}
    ...
    \item Avviare, fermare e reimpostare a 0 secondi un cronometro per
    mantenere traccia del tempo speso per risolvere il quesito scelto.
...
\begin{funcreq}
    ...
    potenzialmente diverso da quelli di altri.
\end{funcreq}
...
interagisce per ottenere supporto e realizzare in tal modo le sue funzionalità.
...
L'invio dei messaggi email sarà gestito da servizi di posta elettronica di terze parti.
\end{backend}

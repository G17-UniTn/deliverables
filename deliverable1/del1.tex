...
\begin{enumerate}
    ...
    elencato (descritti nel \textcolor{blue}{\underbar{\hyperref[metadata]{RNF \ref*{metadata}}}}).
...
problema, specificati nel \textcolor{blue}{\underbar{\hyperref[formatoproblema]{RNF \ref*{formatoproblema}}}}.
\end{funcreq}
...
\begin{enumerate}
    \item Visualizzare il contenuto dell'esercizio (\textcolor{blue}{\underbar{\hyperref[formatoproblema]{RNF \ref*{formatoproblema}}}}).
    
    \item Visualizzare i test cases (\textcolor{blue}{\underbar{\hyperref[test]{RNF \ref*{test}.2}}}).
...
\begin{enumerate}
    ...
    \textit{risolto} nel campo \textit{stato} del problema e i progressi (\textcolor{blue}{\underbar{\hyperref[stats]{RF \ref*{stats}}}}) devono
    essere aggiornati.
\end{enumerate}
\end{funcreq}
...
per conferma e deve rispettare quanto specificato dal \textcolor{blue}{\underbar{\hyperref[legalpassword]{RNF \ref*{legalpassword}}}}. 
...
\begin{nonfuncreq}
\textbf{Disponibilità }
Il downtime annuo della piattaforma non deve eccedere gli intervalli di tempo
indispensabili a eventuali opere di manutenzione, evitando ove possibile
interruzioni di servizio inutilmente prolungate.
\end{nonfuncreq}
...
il servizio in condizioni di connettività sufficienti.
\end{nonfuncreq}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{./immaginife/login.jpeg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{./immaginife/registrazione.jpeg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{./immaginife/homecatalogo.jpeg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{./immaginife/esercitazione.jpeg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{immaginife/backend.jpg}
\end{figure}

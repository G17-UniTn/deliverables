...
\begin{itemize}
    \item Chrome: %da versione
    \item Firefox: %da versione
    \item Edge: %da versione
    \item 
\end{itemize}
\end{nonfuncreq}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{materiale/immaginife/registrazione.jpeg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{materiale/immaginife/homecatalogo.jpeg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{materiale/backend.jpg}
\end{figure}

...
\begin{figure}[H]
\centering
\includegraphics[scale=0.25]{./immaginife/registrazione.jpeg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.25]{./immaginife/homecatalogo.jpeg}
\end{figure}
...
%\begin{backend}
%\textbf{Autenticazione con account google }
...
L'invio dei messaggi di posta elettronica sarà gestito da servizi di terze parti.
\end{backend}

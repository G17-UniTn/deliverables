...
\fancyhead[C]{\footnotesize\textit{Documento:} D1 \hfill SleepCode \hfill \textit{Versione:} 2.0}
...
\end{itemize}
Ogni livello è da considerarsi come sottoinsieme di quello precedente;
ovvero, ad un dato livello, vengono ereditate le funzionalità del livello
precedente, ma non è possibile accedere alle funzionalità disponibili ai
livelli superiori.
...
specificando i dati necessari descritti nel \textcolor{blue}{\underbar{\hyperref[formatoproblema]{RNF \ref*{formatoproblema}}}}.
Inoltre, deve essere fornito un codice risolutivo.
\end{funcreq}

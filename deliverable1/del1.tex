...
insieme ai dati ad esso collegati (preferiti, progressi ecc.). In particolare,
i problemi contrassegnati come preferiti vedranno diminuire il loro valore
del campo \textit{preferito} visibile nell'area di esercitazione
(\textcolor{blue}{\underbar{\hyperref[metadata]{RF \ref*{metadata}.2}}}).

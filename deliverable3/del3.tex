...
di utenti (non sono presenti attributi), e le uniche operazioni disponibili sono:
\begin{itemize}
...
sopra descritte. Facendo riferimento al Diagramma dei Componenti del
documento D1, queste classi sono state in parte estratte da tre componenti
...
\begin{figure}[H]
\centering
\includegraphics[scale = 1]{materiale/class-utenti.pdf}
...
\begin{itemize}
    ...
    grazie alla generalizzazione definita sui tipi di utenti a partire da \texttt{User}.
...
Nel Diagramma dei Componenti è stata individuata la \textit{Pagina di Recupero},
...
questi motivi viene individuata la classe \texttt{RecuperoPwUtente} (Figura \ref{recupero}), che
...
\texttt{RecuperoPwUtente}, mentre quest'ultima si occupa delle operazioni
di recupero per un solo utente.

\begin{figure}[H]
\centering
\hspace*{-1.5cm}
\includegraphics[scale = 0.8]{materiale/class-recupero.pdf}
\caption{Definizione della classe \texttt{RecuperoPwUtente}}
\label{recupero}
\end{figure}
